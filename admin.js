...
// --- 6. REALTIME SYNC ENGINE (MATCH CENTER LOGIC) ---
...
// --- 11. SCHEDULER & EVENT ENGINE (MATCH CENTER LOGIC) ---
...
async function initTournamentRound(sportId, sportName, sportType) {
    ...
    // --- NEXT ROUNDS ---
        ...
        if (pendingCount > 0) return showToast(`Round ${lastRound} unfinished!`, "error");
...
// --- 12. FORCE WINNER (MATCH CENTER LOGIC) ---
...
async function confirmForceWinner(sportId, sportName) {
    ...
    // FIX: Check for existing "Final" result to avoid duplicates
...
// --- 14. MATCH LIST & FILTER (MATCH CENTER LOGIC) ---
